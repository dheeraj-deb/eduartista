  ...
  return (
    <>
      <div className="relative bg-white">
        ...
        />
        <container className="bg-gray-300 mt-10 font-sans lg:bg-transparent flex flex-col lg:flex-row  justify-center lg:top-1/2 lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2 px-5 xl:px-0 py-8 lg:py-0 w-full gap-6 items-center lg:items-stretch">
          {/* first portion */}
          <div className="flex flex-col flex-wrap max-w-[360px] md:w-[384px] min-h-[572px] p-6 bg-[#365CCE] group rounded-2xl relative overflow-hidden">
            <div className="text-start text-white">
              ...
              <br />
              <span className="font-bold text-3xl">Hello Alexandra,</span>
              <br />
              <div className="text-lg leading-7">
                Renew your plan,to continue with us.
              </div>
              <RightArrow />
            </div>
              ...
              <div className="h-28 ">
                <div className="flex flex-col gap-4 justify-between absolute left-6 right-6 bottom-6">
                  ...
                  <div className="flex align-bottom">
                    <button className="w-full rounded-xl font-semibold text-xl px-4 py-3 bg-[#365CCE] text-white">
                      {data.button}
                    </button>
                  </div>
                </div>
